...
NVS_KEYS = {
    ...
    "hw_revision": ("string", ""),
    "api_url": ("string", "https://boite-a-coeur.fr"),
    "api_url_b1": ("string", "https://update.bac-tcy.com"),
    "api_url_b2": ("string", "https://update.tcy-services.com"),
    "configured": ("u8", "0"),
    "claimed": ("u8", "0"),
    "ssid": ("string", ""),
    "psw": ("string", ""),
...
def _identity_rows(identity: dict) -> list[tuple[str, str, str]]:
    ...
    values = {
        ...
        "api_url": identity.get("api_url", "https://boite-a-coeur.fr"),
        "api_url_b1": identity.get("api_url_b1", "https://update.bac-tcy.com"),
        "api_url_b2": identity.get("api_url_b2", "https://update.tcy-services.com"),
