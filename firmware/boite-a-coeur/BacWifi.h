...
public:
    ...
    void startConnect(const char *ssid, const char *pass, bool bleContention = false, bool skipChannelScan = false) {
        ...
        if (!bleContention && !skipChannelScan) channel = findChannelForSsid(ssid);
...
public:
    ...
    void startConnect(const char *, const char *, bool = false, bool = false) {}
