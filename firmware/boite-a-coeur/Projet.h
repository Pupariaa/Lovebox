...
Label w2(0, 92, "il semblerait que votre boîte à cœur", TextAlign::Left);
...
Label w6(0, 196, "depuis l'application Boîte à Cœur", TextAlign::Left);
...
Label w12(0, 105, "votre boîte à cœur !", TextAlign::Left);
...
Label w22(0, 74, "pour configurer votre boîte à cœur", TextAlign::Left);
...
Label w33(0, 165, "Votre boîte à cœur est ", TextAlign::Left);
...
Label w45(0, 34, "Envoyer un cœur", TextAlign::Left);
...
Label w56(0, 73, "Boîte à cœur d'internet ?", TextAlign::Left);
Label w57(0, 60, "Déconnexion en cours...", TextAlign::Left);
Icon w58(109, 113, "glyphs:spinner-2@w:w_mrbeuqokd", 1);
Label w59(0, 47, "La Boîte à cœur a été déconnectée", TextAlign::Left);
Label w60(0, 106, "Pour utiliser la Boîte à cœur, ", TextAlign::Left);
...
Label w84(0, 60, "Réinitialiser la Boîte à cœur ?", TextAlign::Left);
...
Icon w93(76, 56, "glyphs:monitor@w:w_mrbusmon1", 2);
...
Screen screen_scr_mrbusmon1("usb_connected");
...
inline void build(UI &ui) {
  ...
  lucarne::setIconLookups(projet::iconRowsByRef, projet::iconImageByRef,
                          projet::iconAnimByRef);
  ...
  w48.addItem(BacLocale::lbl_settings, "glyphs:cog", &screen_scr_mr14qsc4g,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 1});
  {
    TextStyle st;
  ...
  w48.addItem(BacLocale::lbl_reset, "glyphs:arrows-round",
              &screen_scr_mr171rmq2y, Transition::Inherit,
              MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
    st.hasColor = true;
  ...
  w48.addItem(BacLocale::lbl_info, "glyphs:comment-info",
              &screen_scr_mr16kq912c, Transition::Inherit,
              MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
  ...
  w48.addItem(BacLocale::lbl_quit, nullptr, &screen_scr_mqzyaiw41j,
              Transition::Inherit, MenuItemOpts{nullptr, true, 0, 0});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
    st.hasColor = true;
  ...
  w49.addItem(BacLocale::lbl_wifi, "glyphs:wifi-100", &screen_scr_mr15ivvsd,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 1});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
  ...
  w49.addItem(BacLocale::lbl_language, "glyphs:globe", &screen_scr_mr15nlgnn,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
    st.hasColor = true;
  ...
  w49.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr14c6nfb,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w50.addItem(BacLocale::lbl_disconnect, nullptr, &screen_scr_mr15t4tyy,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 1});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
  ...
  w50.addItem(BacLocale::lbl_test, nullptr, &screen_scr_mr169o9w1o,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  w50.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr14qsc4g,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w52.addItem("Français", nullptr, &screen_scr_mr14qsc4g, Transition::Inherit,
              MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w52.addItem("Deutsch", nullptr, &screen_scr_mr14qsc4g, Transition::Inherit,
              MenuItemOpts{nullptr, true, 0, 0});
  w52.addItem("Português", nullptr, &screen_scr_mr14qsc4g, Transition::Inherit,
              MenuItemOpts{nullptr, true, 0, 0});
  w52.addItem("español", nullptr, &screen_scr_mr14qsc4g, Transition::Inherit,
              MenuItemOpts{nullptr, true, 0, 0});
  w52.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr14qsc4g,
              Transition::Inherit, MenuItemOpts{nullptr, true, 0, 0});
  ...
  w53.addCallbackItem(BacLocale::lbl_confirm,
                      "glyphs:check-double@w:w_mr15tyzu13_it_mr15tyzu14", 1,
                      MenuItemOpts{nullptr, true, 24, 1});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
    st.hasColor = true;
  ...
  w53.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr15ivvsd,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w63.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mqwqhtj72,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w68.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr15ivvsd,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w72.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr15ivvsd,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w81.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr14c6nfb,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
  ...
  w82.addItem(BacLocale::lbl_confirm,
              "glyphs:check-double@w:w_mr172rxd32_it_mr172rxd33",
              &screen_scr_mr1760ww3i, Transition::Inherit,
              MenuItemOpts{nullptr, true, 24, 1});
  {
    TextStyle st;
    st.color = color565(0, 0, 0);
  ...
  w82.addItem(BacLocale::lbl_back, nullptr, &screen_scr_mr14c6nfb,
              Transition::Inherit, MenuItemOpts{nullptr, true, 24, 0});
  {
    TextStyle st;
    st.font = &LucarneFontBody;
...
inline void update() { input.update(); }
...
//   display.begin(projet::displayPins(), projet::displayOptions(), buffer,
//   &SPI); projet::build(ui); projet::attachInput(ui); ui.begin(); void loop()
//   { projet::update(); ui.update(); }
